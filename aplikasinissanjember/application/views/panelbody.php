...
<html>
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="<?php echo base_url(); ?>layout/assets/images/logonissan.png">
        ...
        <script src="<?php echo base_url('layout/assets/js/jquery-3.3.1.min.js');?>"></script>
    <script src="<?php echo base_url('layout/assets/js/jquery.min.js');?>"></script>
    <script src="<?php echo base_url('layout/assets/js/jquery-3.3.1.js');?>"></script>
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a class="logo">
                        <span>
                            <img src="<?php echo base_url(); ?>layout/assets/images/logonissan.png" alt="" height="45">
                        </span>
                        <i>
                            <img src="<?php echo base_url(); ?>layout/assets/images/logonissan.png" alt="" height="28">
                        </i>
                    </a>
                </div>
            ...
            <div class="content-page">
                            ...
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Sistem Informasi Nissan Jember</a>
                                        </li>
                                    </ol>
                                    <div class="clearfix"></div>
                                </div>
                ...
                <footer class="footer text-right">
                    2018 &copy; Sistem Informasi Nissan Jember
                </footer>
