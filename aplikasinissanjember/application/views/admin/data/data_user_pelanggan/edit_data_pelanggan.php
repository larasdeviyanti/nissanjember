<?php 
echo form_open('Data/proses_edit_data_pelanggan','class="form-horizontal" role="form"');
...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <h4 class="m-t-0 header-title"><b>Edit Data Pelanggan</b></h4>
            <div class="row">
                <div class="col-md-12">
                    <div class="p-20">
                        <input type="hidden" name="id_user" class="form-control" id="exampleInputEmail1" value="<?php echo $list['id_user'] ?>">        
                        <div class="form-group">
                        <label class="col-md-2 control-label" for="exampleInputEmail1" >Nama Pelanggan</label>
                            <div class="col-md-10">
                                <input type="text" name="nama_pelanggan" class="form-control" id="exampleInputEmail1" value="<?php echo $list['nama_pengguna'] ?>">
                            </div>
                        </div>
                        ...
                        <label class="col-md-2 control-label" for="exampleInputEmail1">No KTP</label>
                            <div class="col-md-10">
                                <input type="text" name="no_ktp" class="form-control" id="exampleInputEmail1" value="<?php echo $list['no_ktp'] ?>">
                            </div>
                         </div>
                        ...
                        <label class="col-md-2 control-label" for="exampleInputEmail1">Tempat/Tanggal Lahir</label>
                            <div class="col-md-10">
                                <input type="text" name="tmpt_tgl" class="form-control" id="exampleInputEmail1" value="<?php echo $list['tmpt_tgl'] ?>">
                            </div>
                         </div>
                        ...
                        <label class="col-md-2 control-label" for="exampleInputEmail1">Alamat</label>
                            <div class="col-md-10">
                                <Textarea name="alamat" class="form-control" id="exampleInputEmail1" value="" required=""><?php echo $list['alamat'] ?></Textarea>
                            </div>
                        </div>
                        ...
                        <label class="col-md-2 control-label" for="exampleInputEmail1">No hp</label>
                            <div class="col-md-10">
                                <input type="text" name="no_hp" class="form-control" id="exampleInputEmail1" value="<?php echo $list['no_hp'] ?>">
                            </div>
                         </div>
                        ...
                        <label class="col-md-2 control-label" for="exampleInputEmail1">Email</label>
                            <div class="col-md-10">
                                <input type="text" name="email" class="form-control" id="exampleInputEmail1" value="<?php echo $list['email'] ?>">
                            </div>
                         </div>
                        ...
                        <label class="col-md-2 control-label" for="exampleInputEmail1">Username</label>
                            <div class="col-md-10">
                                <input type="text" name="username" class="form-control" id="exampleInputEmail1" value="<?php echo $list['username'] ?>">
                            </div>
                         </div>
                        ...
                        <label class="col-md-2 control-label" for="exampleInputEmail1">Password</label>
                            <div class="col-md-10">
                                <input type="text" name="password" class="form-control" id="exampleInputEmail1" value="<?php echo $list['password'] ?>">
                            </div>
                         </div>
					...
					<div class="form-group">
                        <label class="col-md-2 control-label" for="exampleInputEmail1">No Plat </label>
                            <div class="col-md-10">
                                <input type="text" name="no_plat" class="form-control" id="exampleInputEmail1" value="<?php echo $data->no_plat ?>" required="">
                            </div>
                         </div>
						<div class="form-group">
                        <label class="col-md-2 control-label" for="exampleInputEmail1">No BPKB Mobil </label>
                            <div class="col-md-10">
                                <input type="text" name="no_bpkb" class="form-control" id="exampleInputEmail1" value="<?php echo $data->no_bpkb ?>" required="">
                            </div>
                         </div>
                        ...
                        <label class="col-md-2 control-label" for="exampleInputEmail1">No Mesin Mobil </label>
                            <div class="col-md-10">
                                <input type="text" name="no_mesin" class="form-control" id="exampleInputEmail1" value="<?php echo $data->no_mesin ?>" required="">
                            </div>
                         </div>
						 <div class="form-group">
                        <label class="col-md-2 control-label" for="exampleInputEmail1">No Rangka Mobil </label>
                            <div class="col-md-10">
                                <input type="text" name="no_rangka" class="form-control" id="exampleInputEmail1" value="<?php echo $data->no_rangka ?>" required="">
                            </div>
                         </div>
                        ...
                        <input type="hidden" id="jumlah_mobil" name="jumlah_mobil" value="<?php echo $list['jumlah_mobil'] ?>">
