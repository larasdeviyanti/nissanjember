<div class="row">
    <div class="col-sm-12">
        <div class="card-box table-responsive">
                ...
                <h2 class="m-t-0 header-title"><b>Data Service</b></h2>
    ...
    <div class="col-sm-12">
        <table id="datatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                ...
                <tr role="row">
                    ...
                    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 250px;">Nama User
                    </th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <?php
                            echo anchor('Data/edit_tampil_dataservice/'.$data->id_data_service,'Edit','id="btnTest" type="button" class="btn btn-warning btn-bordered waves-effect w-md waves-light" style="margin-bottom:5px;"');
                            echo anchor('Data/hapus_tampil_dataservice/'.$data->id_data_service,'Hapus','id="btnTest" type="button" class="btn btn-danger btn-bordered waves-effect w-md waves-light"');
                            ?>
                        </td>
                    </tr>
                        <?php 
