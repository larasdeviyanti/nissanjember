...
<div class="row">
    <div class="col-sm-12">
        <div class="card-box">
            <h4 class="m-t-0 header-title"><b>Edit Data Daftar Service</b></h4>
            <div class="row">
                <div class="col-md-12">
                    <div class="p-20">
                        <div class="form-group">
                        <label class="col-md-2 control-label" for="exampleInputEmail1" >ID Daftar Service</label>
                            <div class="col-md-10">
						...
						<div class="form-group">
                        <label class="col-md-2 control-label" for="exampleInputEmail1">Estimasi Kerusakan</label>
                            <div class="col-md-10">
                        ...
                        <label class="col-md-2 control-label" for="exampleInputEmail1">Astimasi Kerusakan</label>
                            <div class="col-md-10">
                                <input type="text" name="astimasi_kerusakan" class="form-control" id="exampleInputEmail1" value="<?php echo $list['ekkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkstimasi_kerusakan'] ?>" >
                            </div>
                         </div> -->
                        <div class="form-group">
